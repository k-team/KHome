...
def creerjsonRetour(cmd):
    ...
    list_obj_data1 += [{'time':1, 'value':1},{'time':2, 'value':2},{'time':3, 'value':3},{'time':4, 'value':4},{'time':5, 'value':5}]

    list_obj_data1 += [{'time':10, 'value':11},{'time':12, 'value':12},{'time':13, 'value':13},{'time':14, 'value':14},{'time':15, 'value':15}]
