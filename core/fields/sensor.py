...
Butane = Dummy(lambda t:
        math.sin(t) * 1 + 0.5 + 0.5 * (random.random() - 0.5)) #seuil 1500

CO = Dummy(lambda t:
        math.sin(t) * 17 + 3 + 0.5 * (random.random() - 0.5)) # seuil 60
...
Methane = Dummy(lambda t:
        math.sin(t) * 5 + 0.5 + 0.5 * (random.random() - 0.5)) # seuil max 1000

Moisture = Dummy(lambda t:
        math.sin(t) * 20 + 35 + 0.5 * (random.random() - 0.5)) # seuil max 45

Propane = Dummy(lambda t:
        math.sin(t) * 1.2 + 0.5 + 0.5 * (random.random() - 0.5)) # seuil 1500
